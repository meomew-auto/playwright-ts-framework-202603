...
export abstract class BasePage {
  ...
  >(locatorMap: T) {
    ...
    return <K extends keyof T>(locatorName: K): GetLocatorType<K> => {
      ...
      if (typeof locatorDef === 'function') {
        ...
        if (paramCount === 1) {
          return (locatorDef as (page: Page) => unknown)(this.page) as GetLocatorType<K>;
        }
        ...
        return ((...args: unknown[]) => {
          return (locatorDef as (page: Page, ...args: unknown[]) => unknown)(this.page, ...args);
        }) as GetLocatorType<K>;
      }
  ...
  protected createResponsiveLocatorGetter<
    TBase extends Record<string, string | ((page: Page) => unknown) | ((page: Page, ...args: never[]) => unknown)>,
    TOverrideMap extends Partial<Record<keyof TBase, string | ((page: Page) => unknown) | ((page: Page, ...args: never[]) => unknown)>>
